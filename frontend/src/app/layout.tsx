...
export const metadata: Metadata = {
  title: "mycoach — AI Software Engineer Coach",
  description:
    "Personal learning platform for software engineers. Practice algorithms, learn data structures, and contribute to open source with AI coaching.",
};
